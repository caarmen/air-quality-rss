      ...
      *> ===============================================================
       ...
       LOCAL-STORAGE SECTION.
           01  QUERY-PARAM-VALUE-PTR      USAGE POINTER.
           01  QUERY-PARAM-SIZE-PTR       USAGE POINTER.
       ...
       .
           CALL "MHD_lookup_connection_value_n" USING
               ...
               BY REFERENCE QUERY-PARAM-VALUE-PTR
               BY REFERENCE QUERY-PARAM-SIZE-PTR

           IF QUERY-PARAM-SIZE-PTR = NULL
           THEN
               MOVE 1 TO RETURN-CODE *> Failure
           ELSE
               CALL "C-STRING" USING
                   BY VALUE     QUERY-PARAM-VALUE-PTR
                   BY REFERENCE QUERY-PARAM-VALUE
      ...
      *> ===============================================================
       ...
       DATA DIVISION.
       LOCAL-STORAGE SECTION.
           01  QUERY-PARAM-VALUE-STR      PIC X(100)       VALUE SPACES.
       ...
       PROCEDURE DIVISION USING
           ...
           CALL "PARSE-QUERY-PARAM" USING
               BY VALUE     CONNECTION-PTR
               BY REFERENCE QUERY-PARAM-NAME
               BY REFERENCE QUERY-PARAM-VALUE-STR
               RETURNING RETURN-CODE
           IF RETURN-CODE = 0
           THEN
               MOVE QUERY-PARAM-VALUE-STR TO QUERY-PARAM-VALUE
           END-IF
