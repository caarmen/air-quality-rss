      ...
      *> ===============================================================
       ...
       LOCAL-STORAGE SECTION.
           ...
           01  C-MHD-GET-ARGUMENT-KIND    CONSTANT AS 8.

       LINKAGE SECTION.
           01  IN-CONNECTION-PTR          USAGE POINTER.
           01  IN-QUERY-PARAM-NAME        PIC X(16)        VALUE SPACES.
           01  OUT-QUERY-PARAM-VALUE      PIC X(100)       VALUE SPACES.

       PROCEDURE DIVISION USING
           BY VALUE IN-CONNECTION-PTR
           BY REFERENCE IN-QUERY-PARAM-NAME
           BY REFERENCE OUT-QUERY-PARAM-VALUE
       .
           CALL "MHD_lookup_connection_value_n" USING
               BY VALUE    IN-CONNECTION-PTR
               BY VALUE    C-MHD-GET-ARGUMENT-KIND
               BY VALUE    FUNCTION TRIM(IN-QUERY-PARAM-NAME)
               BY VALUE    LENGTH OF FUNCTION TRIM(IN-QUERY-PARAM-NAME)
      ...
      *> ===============================================================
       ...
       LINKAGE SECTION.
           01  IN-CONNECTION-PTR          USAGE POINTER.
           01  IN-QUERY-PARAM-NAME        PIC X(16)        VALUE SPACES.
           01  OUT-QUERY-PARAM-VALUE      PIC S9(3)V9(8).
       ...
       PROCEDURE DIVISION USING
           ...
           IF RETURN-CODE = 0
           THEN
               MOVE LS-QUERY-PARAM-VALUE-STR TO OUT-QUERY-PARAM-VALUE
           END-IF
